...
const Login = (props) => {
   const router = useRouter()
    ...
    const getUser = ()=>{
        let user = {}
        if(emailValidator(credentials.email_username)) user = {password:credentials.password,email:credentials.email_username,isEmail:true}
    ...
    return (<div className="dark:bg-white  dark:text-black tablet_md:w-[70vw] md_laptop:w-[50vw] above_laptop:w-[30vw] w-full mobile:m-0 m-2 p-3 space-y-2 rounded-md transition-all">
